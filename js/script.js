(function($){
	...
	$(document).ready(function() {
		...
		/*ColorBox*/
		if ($(window).width() >= 760) {
			$(".youtube").colorbox({iframe:true, innerWidth:950, innerHeight:690});
		}else{
		...
		$(".story_wrapper").owlCarousel({
	 		navigation : true,	responsive: true, responsiveRefreshRate : 2000,	slideSpeed : 500,	
	 		paginationSpeed : 5000,	rewindSpeed : 500,	items:3,  itemsTablet: [768,1], autoPlay : false,
